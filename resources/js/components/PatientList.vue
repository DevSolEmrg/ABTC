  ...
  <el-col :span="24">
    <el-card shadow="never" :body-style="{ padding: '0px' }">
        <div slot="header">
            ...
            <div class="row">
                <div class="col-5 px-1">
                    <el-input v-model="search" size="mini" prefix-icon="el-icon-search" placeholder="Type to search">
        ...
        <el-table  v-loading="loading" :data="ListData">
            ...
            <el-table-column width="103" align="center" fixed="right" label="Action">
