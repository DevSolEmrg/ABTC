        ...
        <el-aside v-if="side_nav" style="background-color: #272E3F; overflow-x:hidden">
            ...
            >
                ...
                <el-submenu index="general_setting">
                    ...
                    <el-menu-item index="App Instance" :route="{ name: 'App Instance' }" @click="handlePageLoading('App Instance')" style="padding-left:53px">App Instance <span class="mdi mdi-alert-outline" style="color:green" /></el-menu-item>
                </el-submenu>
